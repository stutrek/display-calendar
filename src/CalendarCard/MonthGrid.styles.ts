...
.day-cell {
  ...
  background: none;
  border: none;
  /* Reset iOS Safari's native button styling so the button can shrink to fit
     its grid track. Without these, Safari < 16 gives buttons an implicit
     min-content sizing that pushes other tracks off-screen — visible as the
     calendar dropping its last two day columns. */
  ...
  /* touch-action: manipulation removes the 300ms tap delay on iOS Safari
     for elements that don't have a documented double-tap meaning. */
